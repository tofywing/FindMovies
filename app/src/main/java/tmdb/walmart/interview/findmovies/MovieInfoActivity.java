...
public class MovieInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        upArrow.setColorFilter(ContextCompat.getColor(this, R.color.pureBlack), PorterDuff.Mode.SRC_ATOP);
        ...
        Picasso.with(this).load(url).centerCrop().resize(720, 1080).into(mMoviePoster, new Callback() {
            @Override
            ...
            @Override
            public void onError() {
                Picasso.with(getApplicationContext()).load(R.drawable.no_image_available).centerCrop().resize
                        (720, 1080).into(mMoviePoster);
            }
        });
    }
}
